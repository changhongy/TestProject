...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/bookServlet?method=updateBook"
		method=post>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								<td>图书名称：</td>
								<td>
									<INPUT class=textbox id=sChannel2 style="WIDTH: 180px" maxLength=50 name="bookname" value="${book.bookname}">
								</td>
							</TR>
							<TR>
								<td>图书类别：</td>
							...
							<TR>
								<td>上架时间 ：</td>
								<td>
									<INPUT class=textbox type="date" id=sChannel2 style="WIDTH: 180px" maxLength=50 name="uptime">
								</td>
							</TR>
							<TR>
